...
-- Importamos las bibliotecas standard de Awesome
local gears         = require("gears") --Utilities such as color parsing and objects
local awful         = require("awful") --Everything related to window managment

-- esto es basicamente una funcion
require("awful.autofocus")

-- esto se utiliza para crear paneles
local wibox         = require("wibox")

-- esto es para personalizar la estetica del repositprio
...
globalkeys = my_table.join(
	...
	--ejemplo de como se define un atajo de teclado con awful.key
	--primer argumento: tabla con las teclas a presionar
        awful.key(
           	{modkey, "Shift"},
            	's',
            	function()
   ...
   -- awful.key({ modkey }, "Right", function () lain.util.tag_view_nonempty(1) end,
    ...
    -- Atajos para desplazarnos entre ventanas
    awful.key({altkey}, "j",
	function ()
